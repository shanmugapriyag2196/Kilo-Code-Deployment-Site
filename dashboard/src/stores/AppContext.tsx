  ...
  const syncProjectFromGitHub = useCallback(async (projectId: string, projectOverride?: Project): Promise<Deployment[]> => {
    ...
    commits.forEach((commit, index) => {
      ...
      const deployment: Deployment = {
        ...
        deploymentUrl: generateVercelUrl(project.name, project.gitRepository, 'main', 'production', deploymentId),
    ...
    const envDeployment = {
      ...
      url: generateVercelUrl(project.name, project.gitRepository, 'main', 'production', newDeployments[0].id),
      branch: 'main',
